...
public class RobotContainer {
  ...
  XboxController m_xbox_cotroller = new XboxController(0);
  ...
  private void configureButtonBindings() {
    SwerveController drive_robot = new SwerveController(swerveDrive,
        () -> {
          return m_xbox_cotroller.getRawAxis(0);
        },
        () -> {
          return m_xbox_cotroller.getRawAxis(1);
        },
        () -> {
          return m_xbox_cotroller.getRawAxis(4);
        });
